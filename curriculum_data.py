...
TOPICS = {
    ...
    # ─── PRIMARY 5–6 ────────────────────────────────────────────────────────────
    "p56_fractions_adv":  {"name":"Advanced Fractions","level":"Primary 5–6","sg":"Primary 5–6","color":"#3CB371","prereqs":["p34_fractions","p34_decimals"],"hours":6,"emoji":"🍕","tagline":"Complex fractions solved step-by-step"},
    "p56_ratio":          {"name":"Ratio & Proportion","level":"Primary 5–6","sg":"Primary 5–6","color":"#3CB371","prereqs":["p56_fractions_adv"],"hours":5,"emoji":"⚖️","tagline":"3:5 — what does it mean?"},
    "p56_percentage":     {"name":"Percentage","level":"Primary 5–6","sg":"Primary 5–6","color":"#3CB371","prereqs":["p56_fractions_adv","p34_decimals"],"hours":5,"emoji":"%","tagline":"Per hundred — discounts, GST, interest"},
    "p56_average":        {"name":"Average (Mean)","level":"Primary 5–6","sg":"Primary 5–6","color":"#3CB371","prereqs":["p34_data","p34_long_mult_div"],"hours":3,"emoji":"📊","tagline":"What's the fair share?"},
    "p56_algebra_intro":  {"name":"Intro to Algebra","level":"Primary 5–6","sg":"Primary 5–6","color":"#3CB371","prereqs":["p34_long_mult_div"],"hours":5,"emoji":"🔡","tagline":"Let x be the unknown"},
    "p56_volume":         {"name":"Volume (3D shapes)","level":"Primary 5–6","sg":"Primary 5–6","color":"#3CB371","prereqs":["p34_perimeter_area"],"hours":4,"emoji":"📦","tagline":"How much fits inside?"},
    "p56_data_analysis":  {"name":"Data Analysis","level":"Primary 5–6","sg":"Primary 5–6","color":"#3CB371","prereqs":["p34_data","p56_average"],"hours":3,"emoji":"📈","tagline":"Pie charts, tables, interpretation"},
    "p56_problem_solving":{"name":"Problem Solving (PSLE-style)","level":"Primary 5–6","sg":"Primary 5–6","color":"#3CB371","prereqs":["p56_ratio","p56_percentage","p56_algebra_intro"],"hours":8,"emoji":"🧩","tagline":"Heuristics and model drawing"},
