...
<svg width="200" height="150" style="border: 1px solid #ccc; margin: 10px;">
  ...
  <text x="115" y="70" font-size="14">radius</text>
  <circle cx="100" cy="75" r="3" fill="red"/>
  <text x="90" y="95" font-size="14">center</text>
</svg>
...
<svg width="300" height="150" style="border: 1px solid #ccc; margin: 10px;">
  <text x="50" y="20" font-size="16" font-weight="bold">Square</text>
  <rect x="20" y="40" width="80" height="80" fill="lightyellow" stroke="orange" stroke-width="2"/>
  ...
  <text x="35" y="135" font-size="12">4 equal sides</text>

  <text x="180" y="20" font-size="16" font-weight="bold">Rectangle</text>
  <rect x="150" y="40" width="120" height="60" fill="lightgreen" stroke="darkgreen" stroke-width="2"/>
  ...
  <text x="170" y="135" font-size="12">2 long, 2 short sides</text>
</svg>
...
<svg width="350" height="150" style="border: 1px solid #ccc; margin: 10px;">
  <text x="30" y="20" font-size="14" font-weight="bold">Tall Triangle</text>
  ...
  <text x="180" y="20" font-size="14" font-weight="bold">Flat Triangle</text>
  ...
  <text x="300" y="20" font-size="14" font-weight="bold">Wide Triangle</text>
...
<svg width="350" height="120" style="border: 1px solid #ccc; margin: 10px;">
  <text x="10" y="20" font-size="14" font-weight="bold">Pattern Example with Colors:</text>
  ...
  <text x="265" y="70" font-size="16">?</text>
  <text x="20" y="105" font-size="12">Pattern: RED, YELLOW, RED, YELLOW...</text>
  <text x="250" y="105" font-size="12">Next: RED</text>
</svg>
