...
<p style="text-align: center; font-weight: bold;">\(\mathbf{v} = (x, y, z)\) or \(\mathbf{v} = x\mathbf{i} + y\mathbf{j} + z\mathbf{k}\)</p>
...
<p>|<strong>v</strong>| \(= \sqrt{3^2 + (-4)^2 + 12^2}\)</p>
<p>\(= \sqrt{9 + 16 + 144}\)</p>
<p>\(= \sqrt{169} =\) <strong>13</strong></p>
</div>
...
<li>Scalar multiplication distributes: \(k(\mathbf{u} + \mathbf{v}) = k\mathbf{u} + k\mathbf{v}\)</li>
</ul>
"""
    },
    {
...
<p>|<strong>v</strong>| \(= \sqrt{1^2 + 2^2 + 2^2} = \sqrt{1 + 4 + 4} = \sqrt{9} = 3\)</p>
...
<p>The distance between two points \(P(x_1, y_1, z_1)\) and \(Q(x_2, y_2, z_2)\) in 3D space is:</p>
...
<p>Distance: \(d = \sqrt{3^2 + 4^2 + 12^2} = \sqrt{9 + 16 + 144} = \sqrt{169} =\) <strong>13</strong></p>
</div>

<h3>Midpoint of a Line Segment</h3>
<p>The midpoint M of the line segment joining \(P(x_1, y_1, z_1)\) and \(Q(x_2, y_2, z_2)\) is:</p>
