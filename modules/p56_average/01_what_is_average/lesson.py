...
SECTIONS = [
    ...
    },
    {
        ...
        "body": """<h3>The Leveling-Out Idea</h3><p>Imagine water in containers at different heights:</p><svg width="400" height="200" viewBox="0 0 400 200" ><!-- Before averaging --><text x="40" y="20" font-size='14' font-weight='bold'>BEFORE</text><rect x="20" y="100" width="30" height="70" fill='#3498db' stroke='#8b949e' stroke-width="2"/><text x="22" y="185" font-size='12'>5</text><rect x="60" y="60" width="30" height="110" fill='#3498db' stroke='#8b949e' stroke-width="2"/><text x="62" y="185" font-size='12'>7</text><rect x="100" y="40" width="30" height="130" fill='#3498db' stroke='#8b949e' stroke-width="2"/><text x="102" y="185" font-size='12'>9</text><!-- After averaging --><text x="200" y="20" font-size='14' font-weight='bold'>AFTER (Average = 7)</text><rect x="180" y="60" width="30" height="110" fill='#2ecc71' stroke='#8b949e' stroke-width="2"/><text x="182" y="185" font-size='12'>7</text><rect x="220" y="60" width="30" height="110" fill='#2ecc71' stroke='#8b949e' stroke-width="2"/><text x="222" y="185" font-size='12'>7</text><rect x="260" y="60" width="30" height="110" fill='#2ecc71' stroke='#8b949e' stroke-width="2"/><text x="262" y="185" font-size='12'>7</text></svg><p style="margin-top: 10px;">The bars of different heights "level out" to the same height when we find the average.</p>"""
    },
    {
