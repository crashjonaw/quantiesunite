...
<div class="worked-example">
    <div class="concept-box formula-box">
        ...
        <p>For a square matrix A, eigenvalues λ and eigenvectors v satisfy Av = λv. Eigenvectors are directions that don't change direction under the transformation A; eigenvalues are scaling factors.</p>
        ...
        <ul>
            ...
            <li>If λ < 0, the vector gets flipped</li>
            <li>If λ = 0, the direction is in the null space</li>
        </ul>
