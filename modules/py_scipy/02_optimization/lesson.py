...
<div class="worked-example">
    <div class="concept-box formula-box">
        ...
        <ul>
            ...
            <li><strong>Constrained:</strong> Minimize f(x) subject to g(x) ≤ 0</li>
...
<div class="worked-example">
    <div class="concept-box formula-box">
        ...
        <p>Given data points (xᵢ, yᵢ) and a model y = f(x, θ), find parameters θ that minimize:</p>
        <p style="text-align: center; font-family: monospace; margin: 12px 0;">χ² = Σᵢ [yᵢ - f(xᵢ, θ)]²</p>
