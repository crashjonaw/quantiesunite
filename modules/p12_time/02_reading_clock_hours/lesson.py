...
<svg viewBox="0 0 400 360" style="width:100%;max-width:400px;display:block;margin:20px auto;">
  ...
  <text x="50" y="87" text-anchor='middle' font-size='10' fill='currentColor' font-weight='bold'>7</text>
  ...
  <text x="50" y="162" text-anchor='middle' font-size='10' fill='currentColor' font-weight='bold'>8</text>
  ...
  <text x="50" y="237" text-anchor='middle' font-size='10' fill='currentColor' font-weight='bold'>12</text>
  ...
  <text x="50" y="312" text-anchor='middle' font-size='10' fill='currentColor' font-weight='bold'>3</text>
