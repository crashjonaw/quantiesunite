...
"""
    },
    {
        ...
        "body": """
<h3>Z-Confidence Interval (Known σ)</h3>
...
<p>Sample of 50 students: X̄ = 82, σ = 10. Find 95% CI for μ</p>
<p><strong>Solution:</strong></p>
<p>Margin of error = 1.96 × (10/√50)</p>
<p style="text-align: center;">= 1.96 × (10/7.071)</p>
<p style="text-align: center;">= 1.96 × 1.414 ≈ 2.77</p>
<p><strong>95% CI = 82 ± 2.77 = (79.23, 84.77)</strong></p>
<p><em>Interpretation:</em> We are 95% confident that the true population mean lies between 79.23 and 84.77.</p>
</div>

<h3>T-Confidence Interval (Unknown σ)</h3>
<p>When σ is unknown, use sample standard deviation s and the t-distribution:</p>
<p style="text-align: center; font-weight: bold;">CI = X̄ ± t_{α/2, n-1} × (s/√n)</p>

<p>where t_{α/2, n-1} is the critical t-value with df = n - 1 degrees of freedom.</p>

<div class="worked-example">
<h4>Example: T-Confidence Interval</h4>
<p>Sample of 20 patients: X̄ = 150, s = 12. Find 95% CI for μ</p>
<p><strong>Solution:</strong></p>
<p>df = 20 - 1 = 19</p>
<p>t₀.₀₂₅,₁₉ ≈ 2.093</p>
<p>Margin of error = 2.093 × (12/√20) = 2.093 × 2.683 ≈ 5.61</p>
<p><strong>95% CI = 150 ± 5.61 = (144.39, 155.61)</strong></p>
</div>

<h3>Margin of Error</h3>
<p>The <strong>margin of error</strong> is half the width of the confidence interval:</p>
<p style="text-align: center; font-weight: bold;">Margin of Error = z_{α/2} × (σ/√n)</p>

<p>Factors that reduce margin of error:</p>
<ul>
<li>Lower confidence level (smaller z or t critical value)</li>
<li>Larger sample size (larger √n in denominator)</li>
<li>Smaller population standard deviation σ</li>
</ul>
"""
    },
    {
...
<p>A two-tailed hypothesis test at level α is equivalent to checking whether the null value lies in the (1-α)×100% confidence interval.</p>

<p><strong>Rule:</strong></p>
<ul>
<li>If μ₀ is <strong>NOT in</strong> the CI, reject H₀: μ = μ₀ at level α</li>
<li>If μ₀ <strong>IS in</strong> the CI, fail to reject H₀</li>
</ul>
...
<p><strong>Test 1:</strong> H₀: μ = 80 vs H₁: μ ≠ 80 at α = 0.05</p>
<p>Since 80 ∈ (79.23, 84.77), <strong>fail to reject H₀</strong></p>

<p><strong>Test 2:</strong> H₀: μ = 85 vs H₁: μ ≠ 85 at α = 0.05</p>
<p>Since 85 ∉ (79.23, 84.77), <strong>reject H₀</strong></p>
<p>The sample evidence contradicts the claim that μ = 85.</p>
</div>
