...
<div class="diagram-container">
  <svg width="500" height="150" viewBox="0 0 500 150">
    <text x="250" y="25" text-anchor='middle' font-size='16' font-weight='bold'>4 Baskets with 3 Apples Each</text>

    <g id="basket1">
      <rect x="20" y="50" width="60" height="70" fill='none' stroke='#4169E1' stroke-width="2"/>
    ...
    <g id="basket2">
      <rect x="100" y="50" width="60" height="70" fill='none' stroke='#22c55e' stroke-width="2"/>
    ...
    <g id="basket3">
      <rect x="180" y="50" width="60" height="70" fill='none' stroke='#f59e0b' stroke-width="2"/>
    ...
    <g id="basket4">
      <rect x="260" y="50" width="60" height="70" fill='none' stroke='#ef4444' stroke-width="2"/>
    ...
    <text x="400" y="85" font-size='20' font-weight='bold'>3 × 4 = 12</text>
  </svg>
...
<div class="diagram-container">
  <svg width="450" height="250" viewBox="0 0 450 250">
    ...
    <text x="280" y="120" font-size='18' font-weight='bold'>3 × 4 = 12</text>
    <text x="280" y="145" font-size='14'>(3 rows of 4)</text>
  </svg>
