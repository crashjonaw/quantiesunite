...
<ul>
<li>Maria's age = 2 × brother's age</li>
...
<li>2 × Pens + 5 × Notebooks = 35 dollars</li>
</ul>
...
<ul>
<li>Guess 5: 5 × 3 + 7 = 22 (too small)</li>
<li>Guess 8: 8 × 3 + 7 = 31 (too big)</li>
<li>Guess 7: 7 × 3 + 7 = 28 (correct!)</li>
