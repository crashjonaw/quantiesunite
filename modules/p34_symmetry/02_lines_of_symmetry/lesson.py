...
SECTIONS = [
    {
        ...
        <div style="text-align:center;margin:20px 0;">
            <svg viewBox="-5 0 210 150" style="width:100%;max-width:300px;height:auto;display:block;margin:16px auto;">
                ...
                <text x="100" y="145" text-anchor='middle' fill='currentColor' font-size='12' font-weight='bold'>Letter H: Vertical Line of Symmetry</text>
            </svg>
        </div>
    ...
    },
    {
        ...
        <div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 520 350" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
                ...
                <text x="80" y="160" text-anchor='middle' fill='currentColor' font-weight='bold'>Circle: ∞ lines</text>
                ...
                <text x="250" y="160" text-anchor='middle' fill='currentColor' font-weight='bold'>Square: 4 lines</text>
                ...
                <text x="440" y="160" text-anchor='middle' fill='currentColor' font-weight='bold'>Rectangle: 2 lines</text>
                ...
                <text x="80" y="320" text-anchor='middle' fill='currentColor' font-weight='bold'>Equilateral △: 3 lines</text>
                ...
                <text x="280" y="320" text-anchor='middle' fill='currentColor' font-weight='bold'>Isosceles △: 1 line</text>
    ...
    },
    {
        ...
        <div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 250 150" style="width:100%;max-width:350px;height:auto;display:block;margin:16px auto;">
                ...
                <text x="125" y="140" text-anchor='middle' fill='currentColor' font-size='12' font-weight='bold'>Letter A: Vertical Symmetry</text>
            </svg>
        </div>
        ...
        <div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 250 150" style="width:100%;max-width:350px;height:auto;display:block;margin:16px auto;">
                ...
                <text x="125" y="140" text-anchor='middle' fill='currentColor' font-size='12' font-weight='bold'>Letter B: Horizontal Symmetry</text>
            </svg>
        </div>
        ...
        <div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 300 150" style="width:100%;max-width:350px;height:auto;display:block;margin:16px auto;">
                ...
                <text x="115" y="140" text-anchor='middle' fill='currentColor' font-size='12' font-weight='bold'>Square: 2 Diagonal Lines</text>
            </svg>
        </div>
        """
    },
    ...
    },
    {
        ...
        <div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 400 200" style="width:100%;max-width:500px;height:auto;display:block;margin:16px auto;">
                ...
                <text x="200" y="180" text-anchor='middle' fill='currentColor' font-size='12'>Rectangle: 2 lines of symmetry</text>
            </svg>
        </div>
