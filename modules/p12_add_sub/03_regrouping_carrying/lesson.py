...
<svg viewBox="0 0 500 100" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
  <text x="50" y="30" fill='currentColor' font-size='14'>10 ones</text>
  <circle cx="80" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
  <circle cx="95" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
  <circle cx="110" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
  <circle cx="125" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
  <circle cx="140" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
  <circle cx="155" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
  <circle cx="170" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
  <circle cx="185" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
  <circle cx="200" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
  <circle cx="215" cy="45" r="5" fill='#22c55e' stroke='currentColor' stroke-width="1"/>
...
<svg viewBox="0 0 600 240" style="width:100%;max-width:700px;height:auto;display:block;margin:16px auto;">
  <!-- Step 1 -->
  <text x="50" y="25" fill='currentColor' font-size='14' font-weight='bold'>Step 1: Add the ones (7 + 5)</text>
  <text x="50" y="50" fill='currentColor' font-size='13'>7 + 5 = 12</text>
  ...
  <!-- Column work -->
  <text x="300" y="50" fill='currentColor' font-size='12'>Tens  Ones</text>
  <text x="325" y="75" fill='currentColor' font-size='11'>1  ← carry</text>
  <text x="310" y="95" fill='currentColor' font-size='13'>2  7</text>
  <text x="305" y="115" fill='currentColor' font-size='13'>+  1  5</text>
  <line x1="295" y1="125" x2="350" y2="125" stroke='#8b949e' stroke-width="2"/>
  <text x="310" y="145" fill='currentColor' font-size='13'>4  2</text>

  <!-- Step 2 -->
  <text x="50" y="160" fill='currentColor' font-size='14' font-weight='bold'>Step 2: Add the tens (2 + 1 + 1 carry)</text>
...
<svg viewBox="0 0 600 260" style="width:100%;max-width:700px;height:auto;display:block;margin:16px auto;">
  <!-- Step 1 -->
  <text x="50" y="25" fill='currentColor' font-size='14' font-weight='bold'>Step 1: Borrow 1 ten from the tens place</text>
  ...
  <!-- Column work -->
  <text x="320" y="50" fill='currentColor' font-size='12'>Tens  Ones</text>
  <text x="330" y="70" fill='#4f8ef7' font-size='11'>↓</text>
  <text x="310" y="90" fill='currentColor' font-size='13'>3  2</text>
  <text x="305" y="110" fill='currentColor' font-size='13'>-  1  5</text>
  ...
  <text x="310" y="150" fill='currentColor' font-size='13'>2  12</text>

  <!-- Step 2 -->
  <text x="50" y="170" fill='currentColor' font-size='14' font-weight='bold'>Step 2: Now subtract (ones first, then tens)</text>
...
<svg viewBox="0 0 550 140" style="width:100%;max-width:650px;height:auto;display:block;margin:16px auto;">
  <text x="50" y="30" fill='currentColor' font-size='13'>Ones: 8 + 4 = 12 → Write 2, carry 1</text>
...
<svg viewBox="0 0 550 140" style="width:100%;max-width:650px;height:auto;display:block;margin:16px auto;">
  <text x="50" y="30" fill='currentColor' font-size='13'>Ones: 3 &lt; 8, so borrow. 3 becomes 13</text>
