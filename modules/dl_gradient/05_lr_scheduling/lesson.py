...
SECTIONS = [
    {
        ...
        <div class="warning-box" style="border-left: 4px solid #fd7e14; padding: 16px; margin: 12px 0; border-radius: 6px">
            ...
            <ul >
                ...
                <li><strong>Oscillations:</strong> Fixed α can cause bouncing in steep regions</li>
            </ul>
    ...
    },
    {
        ...
        <div class="worked-example" style="padding: 16px; margin: 12px 0; border-radius: 6px">
            ...
            <p>where γ ≈ 0.5 or 0.1 (multiplicative factor), S = epochs between reductions.</p>
            <p><strong>Example:</strong></p>
            <ul >
                <li>Epochs 0-9: α = 0.1</li>
                <li>Epochs 10-19: α = 0.01 (divide by 10)</li>
                <li>Epochs 20-29: α = 0.001 (divide by 10 again)</li>
            </ul>
    ...
    },
    {
        ...
        <div class="concept-box" style="padding: 16px; margin: 12px 0; border-radius: 6px">
            ...
            <p>where λ controls decay rate, t is epoch or iteration count.</p>
            <p><strong>Linear decay:</strong> Reduce linearly from α₀ to ~0.</p>
    ...
    },
    {
        ...
        <div class="success-box" style="padding: 16px; margin: 12px 0; border-radius: 6px">
            <p><strong>Warmup:</strong> Start with α = 0, linearly increase to α₀ over first few epochs/iterations.</p>
            <p><strong>Why:</strong> Prevents instability at initialization. Common in transformers and large-batch training.</p>
            <p><strong>Cosine annealing:</strong> Learning rate follows cosine curve from α₀ to ~0.</p>
