...
SECTIONS = [
  ...
  <div class="steps-container">
    ...
    <div class="step">
      ...
      <p>Increase = 15% of £20 = 0.15 × £20 = £3</p>
  ...
  <div class="formula-box">
    ...
    <p>Or: New Value = Original × (1.15) for 15% increase</p>
  </div>

  <div class="example-box">
    <h4>More Examples:</h4>
    <p>A £50 amount increased by 20%: £50 × 1.20 = £60</p>
    <p>A score of 80 increased by 25%: 80 × 1.25 = 100</p>
    <p>A population of 1000 increased by 5%: 1000 × 1.05 = 1050</p>
  </div>

  <div class="success-box">
    <h4>Shortcut for Method 2:</h4>
    <p>Add the percent to 100%, convert to decimal, and multiply.</p>
    <p>15% increase → (100 + 15)% = 115% = 1.15 × original</p>
  </div>
</div>"""
    },
    {
  ...
  <div class="steps-container">
    ...
    <div class="step">
      ...
      <p>Decrease = 20% of £400 = 0.20 × £400 = £80</p>
  ...
  <div class="formula-box">
    ...
    <p>$$\\text{New Value} = \\text{Original} \\times \\left(1 - \\frac{\\text{Percent}}{100}\\right)$$</p>
    <p>Or: New Value = Original × (0.80) for 20% decrease</p>
  </div>

  <div class="example-box">
    <h4>More Examples:</h4>
    <p>A £50 amount decreased by 10%: £50 × 0.90 = £45</p>
    <p>A 200-page book, 25% reduced: 200 × 0.75 = 150 pages</p>
    <p>A price of £80, 15% off: £80 × 0.85 = £68</p>
  </div>
  ...
  <div class="steps-container">
    ...
    <div class="step">
      ...
      <p><strong>Step 1:</strong> Increase by 20%: £100 × 1.20 = £120</p>
      <p><strong>Step 2:</strong> Decrease the new amount by 20%: £120 × 0.80 = £96</p>
