...
<svg viewBox="0 0 600 200" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
  <text x="300" y="20" text-anchor='middle' fill='currentColor' font-size='15' font-weight='bold'>Comparison Symbols</text>

  <!-- Greater than example -->
  <rect x="30" y="45" width="170" height="65" fill='#4f8ef730' stroke='#4f8ef7' stroke-width="2" rx="4"/>
  <text x="115" y="70" text-anchor='middle' fill='currentColor' font-size='20' font-weight='bold'>487 &gt; 312</text>
  <text x="115" y="95" text-anchor='middle' fill='currentColor' font-size='11'>487 is greater than 312</text>

  <!-- Less than example -->
  <rect x="215" y="45" width="170" height="65" fill='#22c55e30' stroke='#22c55e' stroke-width="2" rx="4"/>
  <text x="300" y="70" text-anchor='middle' fill='currentColor' font-size='20' font-weight='bold'>156 &lt; 329</text>
  <text x="300" y="95" text-anchor='middle' fill='currentColor' font-size='11'>156 is less than 329</text>

  <!-- Equals example -->
  <rect x="400" y="45" width="170" height="65" fill='#f59e0b30' stroke='#f59e0b' stroke-width="2" rx="4"/>
  <text x="485" y="70" text-anchor='middle' fill='currentColor' font-size='20' font-weight='bold'>500 = 500</text>
  <text x="485" y="95" text-anchor='middle' fill='currentColor' font-size='11'>500 is equal to 500</text>
  ...
  <text x="60" y="165" text-anchor='start' fill='currentColor' font-size='11'>The open side of the symbol ALWAYS points to the smaller number.</text>
  <text x="60" y="177" text-anchor='start' fill='currentColor' font-size='11'>487 &gt; 312  (mouth points at 312, the smaller number)</text>
</svg>"""
    },
    {
...
<svg viewBox="0 0 600 280" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
  <text x="300" y="20" text-anchor='middle' fill='currentColor' font-size='15' font-weight='bold'>Step-by-Step Comparison</text>
...
<svg viewBox="0 0 600 200" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
  <text x="300" y="20" text-anchor='middle' fill='currentColor' font-size='15' font-weight='bold'>Number Line from 500 to 600</text>
  ...
  <text x="40" y="105" text-anchor='middle' fill='currentColor' font-size='11'>500</text>
  ...
  <text x="300" y="105" text-anchor='middle' fill='currentColor' font-size='11'>600</text>
  ...
  <text x="560" y="105" text-anchor='middle' fill='currentColor' font-size='11'>700</text>
  ...
  <!-- Order at bottom -->
  <text x="30" y="155" text-anchor='start' fill='currentColor' font-size='12' font-weight='bold'>In order:</text>
  <text x="30" y="175" text-anchor='start' fill='currentColor' font-size='12'>500 &lt; 530 &lt; 590 &lt; 600 &lt; 640 &lt; 700</text>
</svg>"""
    },
    {
...
<svg viewBox="0 0 600 260" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
  <text x="300" y="20" text-anchor='middle' fill='currentColor' font-size='15' font-weight='bold'>Ordering Numbers Practice</text>

  <!-- Example 1 -->
  <rect x="30" y="40" width="540" height="90" fill='#4f8ef720' stroke='#4f8ef7' stroke-width="1" rx="3"/>
  <text x="40" y="60" text-anchor='start' fill='currentColor' font-size='12' font-weight='bold'>Order from smallest to largest: 325, 523, 253</text>
  <text x="40" y="80" text-anchor='start' fill='currentColor' font-size='11'>Step 1: Compare hundreds: 2__ is smallest, 5__ is largest</text>
  <text x="40" y="95" text-anchor='start' fill='currentColor' font-size='11'>Step 2: Between 325 and 523, which is smaller? 325 &lt; 523</text>
  <text x="40" y="110" text-anchor='start' fill='currentColor' font-size='12' font-weight='bold'>Answer: 253 &lt; 325 &lt; 523</text>

  <!-- Example 2 -->
  <rect x="30" y="145" width="540" height="90" fill='#22c55e20' stroke='#22c55e' stroke-width="1" rx="3"/>
  <text x="40" y="165" text-anchor='start' fill='currentColor' font-size='12' font-weight='bold'>Order from largest to smallest: 789, 879, 798</text>
  <text x="40" y="185" text-anchor='start' fill='currentColor' font-size='11'>Step 1: Compare hundreds: All start with 7 or 8</text>
  <text x="40" y="200" text-anchor='start' fill='currentColor' font-size='11'>Step 2: 8__ is the largest. Between 879 and 798 from the remaining</text>
  <text x="40" y="215" text-anchor='start' fill='currentColor' font-size='12' font-weight='bold'>Answer: 879 &gt; 798 &gt; 789</text>
</svg>"""
    },
    {
