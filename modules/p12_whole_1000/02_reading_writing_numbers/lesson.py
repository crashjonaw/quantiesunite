...
TITLE = "Reading and Writing Numbers to 1000"

SECTIONS = [
    {
        "title": "Writing Numbers in Words",
        "body": """<div class="concept-box">
<p>We can write numbers as <strong>digits</strong> (like 347) or as <strong>words</strong> (like "three hundred and forty-seven").</p>
<p>To write a number in words, say each part loudly:</p>
<ul>
<li>Say the <strong>hundreds</strong> part first</li>
<li>Then say <strong>"and"</strong></li>
<li>Then say the <strong>tens and ones</strong> part</li>
</ul>
</div>
...
<svg viewBox="0 0 550 220" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
  ...
  <text x="30" y="180" text-anchor='start' fill='#22c55e' font-size='12'>47 = "forty-seven"</text>
    ...
    {
        "title": "Common Numbers in Words",
        "body": """<div class="concept-box">
<p>Here are some common numbers and how we say them. Notice the patterns:</p>
</div>
...
<svg viewBox="0 0 600 300" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
  ...
  <text x="30" y="280" text-anchor='start' fill='currentColor' font-size='11'>Always use "and" between hundreds and tens-ones (e.g., "three hundred AND fifty-six")</text>
    ...
    {
        "title": "Writing Words as Digits",
        "body": """<div class="concept-box">
<p>Sometimes you need to go the other way: read the words and write the number as digits.</p>
<p><strong>Strategy:</strong> Identify the hundreds part, then the tens-ones part.</p>
</div>
...
<svg viewBox="0 0 600 240" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
  ...
  <text x="30" y="200" text-anchor='start' fill='currentColor' font-size='12'>Hundreds = 9, Tens-ones = 12 → Answer: <strong class="accent-heading">912</strong></text>
    ...
    {
        "title": "Special Case: Numbers with Zero",
        "body": """<div class="concept-box">
<p>What if there are no tens? Or no ones? We use <strong>0</strong> to show that a place is empty.</p>
</div>
...
<svg viewBox="0 0 600 220" style="width:100%;max-width:600px;height:auto;display:block;margin:16px auto;">
  ...
  <text x="300" y="165" text-anchor='middle' fill='currentColor' font-size='14' font-weight='bold'>"Eight hundred" = 800</text>
    ...
    {
        "title": "Worked Example: Reading and Writing",
        "body": """<div class="worked-example">
<p><strong>Question 1:</strong> Write "Two hundred and seventy-four" as a number.</p>
<p><strong>Step 1:</strong> Identify hundreds: "Two hundred" = 2</p>
<p><strong>Step 2:</strong> Identify tens-ones: "seventy-four" = 74</p>
<p><strong>Answer:</strong> <strong>274</strong></p>

<hr style="border:1px dashed #666;margin:10px 0;">

<p><strong>Question 2:</strong> Write 591 in words.</p>
<p><strong>Step 1:</strong> Hundreds digit = 5 → "Five hundred"</p>
<p><strong>Step 2:</strong> Tens-ones = 91 → "ninety-one"</p>
<p><strong>Answer:</strong> <strong>Five hundred and ninety-one</strong></p>
</div>"""
    }
]
