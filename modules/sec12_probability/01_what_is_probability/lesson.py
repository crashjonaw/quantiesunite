...
<ul>
<li>P(Heads) = 1/2 = 50%</li>
<li>P(Tails) = 1/2 = 50%</li>
...
<ul>
<li>Each number (1, 2, 3, 4, 5, 6) has equal chance: 1/6 each</li>
...
<li>Landing on any color: 1/4 each</li>
</ul>
</div>
...
<p><strong>Explanation:</strong> The first flip can be H or T, and the second flip can be H or T. That gives us 2 × 2 = 4 total possibilities.</p>
</div>
...
<p><strong>Explanation:</strong> There are 4 sections total. 2 of them are labeled B. So P(B) = 2/4.</p>
</div>
...
<p><strong>Answer:</strong> A and C are equally likely (both P = 1/4)</p>
