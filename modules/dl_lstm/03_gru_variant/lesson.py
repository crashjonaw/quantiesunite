...
<p><strong>r<sub>t</sub> = σ(W<sub>r</sub> [h<sub>t-1</sub>, x<sub>t</sub>] + b<sub>r</sub>)</strong></p>
...
<p><strong>z<sub>t</sub> = σ(W<sub>z</sub> [h<sub>t-1</sub>, x<sub>t</sub>] + b<sub>z</sub>)</strong></p>
