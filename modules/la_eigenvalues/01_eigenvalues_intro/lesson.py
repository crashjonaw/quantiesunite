...
<p style=';'>These special vectors are called <strong>eigenvectors</strong>. The stretch factor is the <strong>eigenvalue</strong> λ (lambda).</p>
...
<div class='worked-example' style='border-left: 4px solid #4f8ef7; padding: 16px; margin: 12px 0; border-radius: 6px;'>
  ...
  <p style='font-family: monospace; font-size: 16px; margin: 8px 0;'><strong>Av</strong> = λ<strong>v</strong></p>
  <ul style='margin: 8px 0;'>
    <li><strong>A</strong> is the matrix</li>
    <li><strong>v</strong> is the eigenvector (the special direction)</li>
    <li><strong>λ</strong> (lambda) is the eigenvalue (the stretch factor)</li>
  </ul>
</div>
"""
    },
...
<div class='worked-example' style='border-left: 4px solid #4f8ef7; padding: 16px; margin: 12px 0; border-radius: 6px;'>
  ...
  <ul>
    <li>Direction [1, 0] (horizontal) → stretched by eigenvalue λ = 2</li>
    <li>Direction [0, 1] (vertical) → shrunk by eigenvalue λ = 0.5</li>
  </ul>
</div>
...
"""
    },
    {
        ...
        "body": """
<p style=';'>The eigenvalue λ reveals what the transformation does to an eigenvector:</p>

<div class='concept-box' style='border-left: 4px solid #4f8ef7; padding: 16px; margin: 12px 0; border-radius: 6px;'>
  <ul>
    <li><strong>λ > 1</strong> → eigenvector is stretched (grows in magnitude)</li>
    <li><strong>0 < λ < 1</strong> → eigenvector is shrunk (decreases in magnitude)</li>
    <li><strong>λ = 0</strong> → eigenvector collapses to the zero vector</li>
    <li><strong>λ < 0</strong> → eigenvector is flipped in direction and scaled</li>
  </ul>
</div>
