...
<div class="worked-example">
  ...
  <ul>
    ...
    <li>Answer: \\(\\frac{25}{100}\\)</li>
    <li>Simplified: \\(\\frac{1}{4}\\) (divide top and bottom by 25)</li>
  </ul>
</div>
...
<div class="success-box">
  <p><strong>Tip:</strong> If the denominator is 10 or 100, you can use our place value shortcut instead of dividing. For example, \\(\\frac{35}{100} = 0.35\\) (just read the digits).</p>
</div>
...
<div class="concept-box">
  ...
  <ul>
    ...
    <li>You're doing calculations (easier to add 2.3 + 1.7 than \\(2\\frac{3}{10} + 1\\frac{7}{10}\\))</li>
  ...
  <ul>
    ...
    <li>The exact mathematical relationship matters (\\(\\frac{1}{3}\\) is more precise than 0.333...)</li>
    <li>You're comparing sizes (which is bigger: \\(\\frac{2}{3}\\) or \\(\\frac{3}{4}\\)?)</li>
  </ul>
</div>
...
<div class="mcq-group">
  ...
  <div class="mcq-options">
    ...
    <button class="mcq-option" data-correct="false" data-explanation="Not typically. We could write it as a fraction, but decimals are more standard for measurements.">Fraction (like \\(1\\frac{3}{4}\\) m)</button>
  </div>
  <div class="mcq-feedback"></div>
</div>
        """
