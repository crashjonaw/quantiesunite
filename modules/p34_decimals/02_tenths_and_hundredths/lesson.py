...
<svg viewBox="0 0 500 180" style="width:100%;max-width:500px;height:auto;display:block;margin:16px auto;">
  <text x="250" y="18" text-anchor='middle' fill='#e6edf3' font-size='14' font-weight='bold'>One Whole Divided Into 10 Tenths</text>
  ...
  <!-- Labels -->
  <text x="45" y="125" text-anchor='middle' fill='#8b949e' font-size='10'>0.1</text>
  <text x="89" y="125" text-anchor='middle' fill='#8b949e' font-size='10'>0.2</text>
  <text x="133" y="125" text-anchor='middle' fill='#8b949e' font-size='10'>0.3</text>
  <text x="177" y="125" text-anchor='middle' fill='#8b949e' font-size='10'>0.4</text>
  <text x="250" y="125" text-anchor='middle' fill='#ef4444' font-size='10' font-weight='bold'>0.5</text>
  <text x="319" y="125" text-anchor='middle' fill='#8b949e' font-size='10'>0.6</text>
  <text x="365" y="125" text-anchor='middle' fill='#8b949e' font-size='10'>0.7</text>
  <text x="411" y="125" text-anchor='middle' fill='#8b949e' font-size='10'>0.8</text>
  <text x="457" y="125" text-anchor='middle' fill='#8b949e' font-size='10'>0.9</text>

  <!-- Explanation -->
  <text x="250" y="160" text-anchor='middle' fill='#e6edf3' font-size='12'>Each part = 0.1 (one tenth = \\(\\frac{1}{10}\\))</text>
</svg>
...
<svg viewBox="0 0 550 140" style="width:100%;max-width:550px;height:auto;display:block;margin:16px auto;">
  <text x="275" y="18" text-anchor='middle' fill='#e6edf3' font-size='14' font-weight='bold'>Number Line: 0 to 1 in Tenths</text>
  ...
  <text x="30" y="90" text-anchor='middle' fill='#e6edf3' font-size='12'>0</text>

  <line x1="79" y1="53" x2="79" y2="67" stroke='#8b949e' stroke-width="1.5"/>
  <text x="79" y="90" text-anchor='middle' fill='#8b949e' font-size='10'>0.1</text>

  <line x1="128" y1="53" x2="128" y2="67" stroke='#8b949e' stroke-width="1.5"/>
  <text x="128" y="90" text-anchor='middle' fill='#8b949e' font-size='10'>0.2</text>

  <line x1="177" y1="53" x2="177" y2="67" stroke='#8b949e' stroke-width="1.5"/>
  <text x="177" y="90" text-anchor='middle' fill='#8b949e' font-size='10'>0.3</text>

  <line x1="226" y1="53" x2="226" y2="67" stroke='#8b949e' stroke-width="1.5"/>
  <text x="226" y="90" text-anchor='middle' fill='#8b949e' font-size='10'>0.4</text>
  ...
  <text x="324" y="90" text-anchor='middle' fill='#8b949e' font-size='10'>0.6</text>

  <line x1="373" y1="53" x2="373" y2="67" stroke='#8b949e' stroke-width="1.5"/>
  <text x="373" y="90" text-anchor='middle' fill='#8b949e' font-size='10'>0.7</text>

  <line x1="422" y1="53" x2="422" y2="67" stroke='#8b949e' stroke-width="1.5"/>
  <text x="422" y="90" text-anchor='middle' fill='#8b949e' font-size='10'>0.8</text>

  <line x1="471" y1="53" x2="471" y2="67" stroke='#8b949e' stroke-width="1.5"/>
  <text x="471" y="90" text-anchor='middle' fill='#8b949e' font-size='10'>0.9</text>

  <line x1="520" y1="50" x2="520" y2="70" stroke='#4f8ef7' stroke-width="2"/>
  <text x="520" y="90" text-anchor='middle' fill='#e6edf3' font-size='12'>1</text>
...
<svg viewBox="0 0 500 300" style="width:100%;max-width:500px;height:auto;display:block;margin:16px auto;">
  <text x="250" y="20" text-anchor='middle' fill='#e6edf3' font-size='14' font-weight='bold'>100 Hundredths (10×10 Grid)</text>
...
<svg viewBox="0 0 500 140" style="width:100%;max-width:500px;height:auto;display:block;margin:16px auto;">
  <text x="250" y="18" text-anchor='middle' fill='#e6edf3' font-size='14' font-weight='bold'>Place Value in 0.37</text>

  <rect x="30" y="40" width="100" height="60" fill='#1e293b' stroke='#4f8ef7' stroke-width="2" rx="2"/>
  <text x="80" y="55" text-anchor='middle' fill='#8b949e' font-size='11'>Decimal</text>
  <text x="80" y="75" text-anchor='middle' fill='#4f8ef7' font-size='18' font-weight='bold'>0.37</text>

  <text x="155" y="75" text-anchor='middle' fill='#e6edf3' font-size='20'>=</text>

  <rect x="180" y="40" width="90" height="60" fill='#1e293b' stroke='#22c55e' stroke-width="2" rx="2"/>
  <text x="225" y="55" text-anchor='middle' fill='#8b949e' font-size='10'>tenths</text>
  <text x="225" y="75" text-anchor='middle' fill='#22c55e' font-size='16' font-weight='bold'>3</text>

  <text x="295" y="75" text-anchor='middle' fill='#e6edf3' font-size='20'>+</text>

  <rect x="320" y="40" width="90" height="60" fill='#1e293b' stroke='#f59e0b' stroke-width="2" rx="2"/>
  <text x="365" y="55" text-anchor='middle' fill='#8b949e' font-size='10'>hundredths</text>
  <text x="365" y="75" text-anchor='middle' fill='#f59e0b' font-size='16' font-weight='bold'>7</text>

  <text x="435" y="75" text-anchor='middle' fill='#e6edf3' font-size='20'>=</text>

  <text x="470" y="75" text-anchor='middle' fill='#e6edf3' font-size='14' font-weight='bold'>0.37</text>
</svg>
...
<svg viewBox="0 0 500 240" style="width:100%;max-width:500px;height:auto;display:block;margin:16px auto;">
  <text x="250" y="18" text-anchor='middle' fill='#e6edf3' font-size='14' font-weight='bold'>Money and Decimals</text>

  <!-- Example 1: $1.25 -->
  <rect x="20" y="35" width="460" height="50" fill='#0f172a' stroke='#4f8ef7' stroke-width="1" rx="2"/>
  <text x="35" y="55" fill='#e6edf3' font-size='12'><tspan font-weight='bold'>$1.25</tspan> = 1 dollar + 2 dimes + 5 cents</text>
  <text x="35" y="75" fill='#8b949e' font-size='11'>= 1 + 0.20 + 0.05</text>

  <!-- Example 2: $3.42 -->
  <rect x="20" y="100" width="460" height="50" fill='#0f172a' stroke='#22c55e' stroke-width="1" rx="2"/>
  <text x="35" y="120" fill='#e6edf3' font-size='12'><tspan font-weight='bold'>$3.42</tspan> = 3 dollars + 4 dimes + 2 cents</text>
  <text x="35" y="140" fill='#8b949e' font-size='11'>= 3 + 0.40 + 0.02</text>

  <!-- Example 3: $0.87 -->
  <rect x="20" y="165" width="460" height="50" fill='#0f172a' stroke='#f59e0b' stroke-width="1" rx="2"/>
  <text x="35" y="185" fill='#e6edf3' font-size='12'><tspan font-weight='bold'>$0.87</tspan> = 0 dollars + 8 dimes + 7 cents</text>
  <text x="35" y="205" fill='#8b949e' font-size='11'>= 0 + 0.80 + 0.07</text>
</svg>
