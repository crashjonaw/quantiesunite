...
<p>n = 5, k = 2, p = 0.5</p>
<p>nCk = 5C2 = 5!/(2!3!) = 10</p>
<p>P(X = 2) = 10 × (0.5)² × (0.5)³ = 10 × 0.25 × 0.125 = 0.3125</p>
</div>

<div class="warning-box">
<h4>Common Mistakes</h4>
<ul>
<li>Forgetting the binomial coefficient nCk (just using p^k(1-p)^(n-k))</li>
...
<p style="text-align: center; font-weight: bold;">E(X) = μ = np</p>

<p><strong>Variance:</strong></p>
<p style="text-align: center; font-weight: bold;">Var(X) = σ² = np(1-p)</p>

<p><strong>Standard Deviation:</strong></p>
<p style="text-align: center; font-weight: bold;">SD(X) = σ = √(np(1-p))</p>

<h3>Deriving the Mean from First Principles</h3>
<p>Let X₁, X₂, ..., X_n be indicator variables where X_i = 1 if trial i succeeds, 0 otherwise.</p>

<p>Each X_i is Bernoulli(p), so E(X_i) = p and Var(X_i) = p(1-p).</p>

<p>The total number of successes is:</p>
<p style="text-align: center;">X = X₁ + X₂ + ... + X_n</p>

<p>By linearity of expectation:</p>
<p style="text-align: center;">E(X) = E(X₁) + E(X₂) + ... + E(X_n) = p + p + ... + p = np</p>

<p>Since trials are independent:</p>
<p style="text-align: center;">Var(X) = Var(X₁) + Var(X₂) + ... + Var(X_n) = p(1-p) + ... + p(1-p) = np(1-p)</p>

<div class="worked-example">
<h4>Example 2: Manufacturing Quality</h4>
<p>A factory produces items; 5% are defective. In a batch of 200:</p>
<p><strong>Expected number defective:</strong> μ = 200 × 0.05 = 10</p>
<p><strong>Variance:</strong> σ² = 200 × 0.05 × 0.95 = 9.5</p>
<p><strong>Standard deviation:</strong> σ = √9.5 ≈ 3.08</p>
...
<li>The spread (standard deviation) increases with n, but more slowly (proportional to √n)</li>
