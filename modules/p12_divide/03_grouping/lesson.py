"""Grouping — Concept lesson."""

TITLE = "Grouping (Quotitive Division)"

SECTIONS = [
    {
        "title": "What is Grouping?",
        "body": """<p><strong>Grouping</strong> is dividing a total into equal-sized groups when you already know the size of each group. The question is: "How many groups can we make?"</p>
<p>With grouping, you decide the group size, then count how many complete groups you can make from your total.</p>
...
<svg viewBox="0 0 520 250" style="width:100%;max-width:520px;height:auto;display:block;margin:16px auto;">
  ...
  <text x="250" y="245" text-anchor='middle' fill='currentColor' font-size='13'>12 ÷ 3 = 4 groups</text>
    ...
    {
        "title": "Same Problem, Two Ways to Think About It",
        "body": """<p><strong>The same division can be solved two ways! Here's an important discovery:</strong></p>
<p>Look at this division problem: \\(12 \\div 3 = 4\\)</p>
<div class="worked-example">
  <strong>Sharing way (Partitive):</strong><br>
  12 cookies shared equally among 3 friends<br>
  → Each friend gets 4 cookies<br><br>
  <strong>Grouping way (Quotitive):</strong><br>
  12 cookies in groups of 3<br>
  → We can make 4 groups<br><br>
...
<svg viewBox="0 0 500 200" style="width:100%;max-width:500px;height:auto;display:block;margin:16px auto;">
  ...
  <text x="380" y="190" text-anchor='middle' fill='currentColor' font-size='11'>4 groups</text>
    ...
    {
        "title": "Real-World Grouping Examples",
        "body": """<p><strong>When do we use grouping division in real life?</strong></p>
<ul style="font-size:14px;">
  <li><strong>Packing:</strong> 20 eggs in cartons of 6 eggs → how many cartons?</li>
  <li><strong>Organizing:</strong> 15 students in groups of 5 → how many groups?</li>
  <li><strong>Sharing gifts:</strong> 24 stickers on sheets of 4 → how many sheets?</li>
  <li><strong>Teams:</strong> 18 players in teams of 3 → how many teams?</li>
  <li><strong>Packing items:</strong> 12 books in boxes of 2 → how many boxes?</li>
</ul>
...
<svg viewBox="0 0 450 180" style="width:100%;max-width:450px;height:auto;display:block;margin:16px auto;">
  ...
  <circle cx="115" cy="85" r="6" fill='#ef4444'/>

  <circle cx="165" cy="85" r="6" fill='#ef4444'/>
  <circle cx="180" cy="85" r="6" fill='#ef4444'/>

  <circle cx="230" cy="85" r="6" fill='#ef4444'/>
  <circle cx="245" cy="85" r="6" fill='#ef4444'/>

  <circle cx="295" cy="85" r="6" fill='#ef4444'/>
  <circle cx="310" cy="85" r="6" fill='#ef4444'/>
...
<svg viewBox="0 0 500 180" style="width:100%;max-width:500px;height:auto;display:block;margin:16px auto;">
  ...
  <text x="95" y="70" text-anchor='middle' fill='#22c55e' font-size='11' font-weight='bold'>Group 1</text>

  <circle cx="170" cy="100" r="5" fill='#22c55e'/>
  <text x="170" y="135" text-anchor='middle' fill='#22c55e' font-size='13' font-weight='bold'>6</text>
  <text x="170" y="70" text-anchor='middle' fill='#22c55e' font-size='11' font-weight='bold'>Group 2</text>

  <circle cx="245" cy="100" r="5" fill='#22c55e'/>
  <text x="245" y="135" text-anchor='middle' fill='#22c55e' font-size='13' font-weight='bold'>9</text>
  <text x="245" y="70" text-anchor='middle' fill='#22c55e' font-size='11' font-weight='bold'>Group 3</text>

  <circle cx="320" cy="100" r="5" fill='#22c55e'/>
  <text x="320" y="135" text-anchor='middle' fill='#22c55e' font-size='13' font-weight='bold'>12</text>
